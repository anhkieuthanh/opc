...
from nanobot.api.paperclip_bridge import register_paperclip_bridge
...
def create_app(
    ...
    *,
    include_chat_api: bool = True,
    enable_paperclip_bridge: bool = False,
    paperclip_bridge_token: str | None = None,
) -> web.Application:
    ...
    Args:
        ...
        include_chat_api: Whether to mount the OpenAI-compatible chat endpoints.
        enable_paperclip_bridge: Whether to mount the Paperclip bridge dispatch route.
        paperclip_bridge_token: Shared token required by the Paperclip bridge.
    """
    ...
    app["paperclip_bridge_token"] = paperclip_bridge_token

    if include_chat_api:
        app.router.add_post("/v1/chat/completions", handle_chat_completions)
        app.router.add_get("/v1/models", handle_models)
    if enable_paperclip_bridge:
        register_paperclip_bridge(app)
